...
export const metadata: Metadata = {
  title: 'Movers in Boston, MA — NoTimeMover | You Set The Price',
  description:
    'Looking for movers in Boston? NoTimeMover lets you set your own price. Enter your addresses, choose your home size, set your budget — get an instant quote in 60 seconds.',
}
...
const STEPS = [
  {
    ...
    body: 'Enter your pickup and dropoff locations in Boston or anywhere across Greater MA.',
  },
  {
    num: '02',
...
export default function MoversBostonMA() {
  return (
    <>
      <div className="min-h-screen bg-ink text-white">
        ...
        <section className="max-w-5xl mx-auto px-5 sm:px-8 pt-20 sm:pt-28 pb-20 sm:pb-24 text-center">
          ...
          <p className="mt-6 text-[15px] sm:text-[17px] text-white/50 leading-relaxed max-w-2xl mx-auto">
            NoTimeMover lets you set your own price. Pick your addresses, choose
            your home size, set your budget — get quoted in 60 seconds.
          </p>
        ...
        >
          <div className="max-w-5xl mx-auto px-5 sm:px-8 py-16 sm:py-24">
            <div className="rounded-[1.75rem] border border-white/[0.08] bg-white/[0.02] p-8 sm:p-10"
              style={{ boxShadow: 'inset 0 1px 1px rgba(255,255,255,0.05)' }}
            >
              <p
              ...
              <h2 className="text-[28px] sm:text-[32px] font-semibold tracking-tight text-white mb-3">
                Boston neighborhoods &amp; beyond.
              </h2>
              <p className="text-[15px] text-white/50 leading-relaxed max-w-2xl mb-8">
                We move throughout Boston and its surrounding cities. Below are
                the neighborhoods we cover most — if you don&rsquo;t see yours,
                enter your address in the flow and we&rsquo;ll confirm coverage.
              </p>
