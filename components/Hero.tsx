...
function MagneticCTA({ onClick }: { onClick: () => void }) {
  ...
  return (
    ...
    >
      <span className="text-[15px] sm:text-[16px] tracking-tight">Get a Quote</span>
      <span
  ...
  return (
    <>
      <section className="relative min-h-[100dvh] flex flex-col bg-ink overflow-hidden">
        ...
        {/* Center content (z-10) */}
        <div className="relative z-10 flex-1 flex flex-col justify-center items-center text-center px-5 sm:px-8 pt-28 sm:pt-32">
          <motion.div
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.7, ease: SPRING, delay: 1.0 }}
